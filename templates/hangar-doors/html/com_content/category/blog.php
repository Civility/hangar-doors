...
?>
<div class="page-category category<?=$this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Blog">
	<?php if ($this->params->get('show_page_heading')) : ?>
		<h1 class="page-header"> <?=$this->escape($this->params->get('page_heading')); ?></h1>
	<?php endif; ?>

	<?php if ($this->params->get('show_category_title', 1) or $this->params->get('page_subheading')) : ?>
		<h1 class="page-subheading"><?=$this->escape($this->params->get('page_subheading')); ?><?php if ($this->params->get('show_category_title')) : ?><?=$this->category->title; ?><?php endif; ?></h1>
	<?php endif; ?>
	<?=$afterDisplayTitle; ?>
	...
	<?php if (!empty($this->lead_items)) : ?>
		<div class="block">
			<?php foreach ($this->lead_items as &$item) : ?>
				<div class="item item-block item-<?=$leadingcount; ?><?=$item->state == 0 ? ' system-unpublished' : null; ?>"
	...
	<div class="block block-row">
		...
		<div class="block-row cols-<?=(int) $this->columns; ?> <?='row-' . $row; ?>">
			<?php endif; */?>
			<div class="item col-lg-<?=round(12 / $this->columns); ?> col-12">
				<div class="item-block column-<?=$rowcount; ?><?=$item->state == 0 ? ' system-unpublished' : null; ?>"
					itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
					<?php
					$this->item = &$item;
					echo $this->loadTemplate('item');
