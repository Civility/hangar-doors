...
<?php // расположение картнки в категориях ?>
	<?php if($this->item->category_alias == 'news') : ?>
		<?php if ($params->get('show_urls_images_frontend') != 0 || $params->get('show_urls_images_backend') != 0) : ?>
			<a href="<?=JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug,$this->item->catid, $displayData->language)); ?>" itemprop="url"><?=JLayoutHelper::render('joomla.content.blog_image', $this->item); ?></a>
		<?php endif; ?>
	<?php /*elseif(!empty($itemFieldVal['imgsol']) && isset($itemFieldVal['imgsol'])) : ?>
		<?=($itemFieldVal['imgsol']);*/ ?>
	<?php else : ?>
...
<div class="item-content">
		<?=JLayoutHelper::render('joomla.content.blog_style_default_item_title', $this->item); ?>
	...
	<?php if(!empty($this->item->introtext)): ?>
		<?php // текст выводить только для новостей ?>
		<?php if($this->item->category_alias == 'news') : ?>
		<div class="text">
